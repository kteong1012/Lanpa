namespace Lanpa
{
    public interface IBuilderActionVisitor<A>
    {
        ...
        void Accept(LDropDownBuilder lDropDownBuilder, A a);
    }
    ...
    public interface IBuilderActionVisitor<A, B>
    {
        ...
        void Accept(LDropDownBuilder lDropDownBuilder, A a, B b);
    }
    ...
    public interface IBuilderActionVisitor<A, B, C>
    {
        ...
        void Accept(LDropDownBuilder lDropDownBuilder, A a, B b, C c);
    }
    ...
    public interface IBuilderActionVisitor<A, B, C, D>
    {
        ...
        void Accept(LDropDownBuilder lDropDownBuilder, A a, B b, C c, D d);
    }
}